...
class LDA:
    ...
    def __init__(self, n_topics, n_iter=2000, alpha=0.1, eta=0.01, random_state=None,
        ...
        rng = custom_lda.utils.check_random_state(random_state)
    ...
    def transform(self, X, max_iter=20, tol=1e-16):
        ...
        WS, DS = custom_lda.utils.matrix_to_lists(X)
    ...
    def _fit(self, X):
        ...
        """
        random_state = custom_lda.utils.check_random_state(self.random_state)
    ...
    def _initialize(self, X):
        ...
        self.WS, self.DS = WS, DS = custom_lda.utils.matrix_to_lists(X)
    ...
    def loglikelihood(self):
        ...
        return custom_lda._lda._loglikelihood(nzw, ndz, nz, nd, alpha, eta)
    ...
    def _sample_topics(self, rands):
        ...
        custom_lda._lda._sample_topics(self.WS, self.DS, self.ZS, self.nzw_, self.ndz_, self.nz_,
                                alpha, eta, rands)
